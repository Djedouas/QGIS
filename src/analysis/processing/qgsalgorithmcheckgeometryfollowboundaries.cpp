...
auto QgsGeometryCheckFollowBoundariesAlgorithm::name() const -> QString
{
  return QStringLiteral( "checkgeometryfollowboundaries" );
}

auto QgsGeometryCheckFollowBoundariesAlgorithm::displayName() const -> QString
{
  return QObject::tr( "Check Geometry (Follow Boundaries)" );
}

auto QgsGeometryCheckFollowBoundariesAlgorithm::tags() const -> QStringList
{
  return QObject::tr( "check,geometry,follow,boundaries" ).split( ',' );
}

auto QgsGeometryCheckFollowBoundariesAlgorithm::group() const -> QString
{
  return QObject::tr( "Check geometry" );
}

auto QgsGeometryCheckFollowBoundariesAlgorithm::groupId() const -> QString
{
  return QStringLiteral( "checkgeometry" );
}

auto QgsGeometryCheckFollowBoundariesAlgorithm::shortHelpString() const -> QString
{
  return QObject::tr( "This algorithm checks if the polygons follow the boundaries of the reference layer." );
}

auto QgsGeometryCheckFollowBoundariesAlgorithm::flags() const -> Qgis::ProcessingAlgorithmFlags
{
  return QgsProcessingAlgorithm::flags() | Qgis::ProcessingAlgorithmFlag::NoThreading;
}

auto QgsGeometryCheckFollowBoundariesAlgorithm::createInstance() const -> QgsGeometryCheckFollowBoundariesAlgorithm *
{
...
void QgsGeometryCheckFollowBoundariesAlgorithm::initAlgorithm( const QVariantMap &configuration )
{
  ...
  addParameter( new QgsProcessingParameterVectorLayer( QStringLiteral( "REF_LAYER" ), QObject::tr( "Reference layer" ), QList<int>() << static_cast<int>( Qgis::ProcessingSourceType::VectorPolygon ) ) );
...
auto QgsGeometryCheckFollowBoundariesAlgorithm::prepareAlgorithm( const QVariantMap &parameters, QgsProcessingContext &context, QgsProcessingFeedback * ) -> bool
{
...
auto QgsGeometryCheckFollowBoundariesAlgorithm::createFeaturePool( QgsVectorLayer *layer, bool selectedOnly ) const -> QgsFeaturePool *
{
...
auto QgsGeometryCheckFollowBoundariesAlgorithm::processAlgorithm( const QVariantMap &parameters, QgsProcessingContext &context, QgsProcessingFeedback *feedback ) -> QVariantMap
{
  QString dest_output;
  QString dest_errors;
  ...
  const QgsGeometryFollowBoundariesCheck check( checkContext.get(), QVariantMap(), parameterAsVectorLayer( parameters, QStringLiteral( "REF_LAYER" ), context ) );
