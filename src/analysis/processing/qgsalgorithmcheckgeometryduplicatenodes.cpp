...
auto QgsGeometryCheckDuplicateNodesAlgorithm::name() const -> QString
{
  return QStringLiteral( "checkgeometryduplicatenodes" );
}

auto QgsGeometryCheckDuplicateNodesAlgorithm::displayName() const -> QString
{
  return QObject::tr( "Check Geometry (Duplicate Nodes)" );
}

auto QgsGeometryCheckDuplicateNodesAlgorithm::tags() const -> QStringList
{
  return QObject::tr( "check,geometry,duplicatenodes" ).split( ',' );
}

auto QgsGeometryCheckDuplicateNodesAlgorithm::group() const -> QString
{
  return QObject::tr( "Check geometry" );
}

auto QgsGeometryCheckDuplicateNodesAlgorithm::groupId() const -> QString
{
  return QStringLiteral( "checkgeometry" );
}

auto QgsGeometryCheckDuplicateNodesAlgorithm::shortHelpString() const -> QString
{
  return QObject::tr( "This algorithm check the duplicate nodes of geometry (in line or polygon)." );
}

auto QgsGeometryCheckDuplicateNodesAlgorithm::flags() const -> Qgis::ProcessingAlgorithmFlags
{
  return QgsProcessingAlgorithm::flags() | Qgis::ProcessingAlgorithmFlag::NoThreading;
}

auto QgsGeometryCheckDuplicateNodesAlgorithm::createInstance() const -> QgsGeometryCheckDuplicateNodesAlgorithm *
{
...
auto QgsGeometryCheckDuplicateNodesAlgorithm::prepareAlgorithm( const QVariantMap &parameters, QgsProcessingContext &context, QgsProcessingFeedback * ) -> bool
{
...
auto QgsGeometryCheckDuplicateNodesAlgorithm::createFeaturePool( QgsVectorLayer *layer, bool selectedOnly ) const -> QgsFeaturePool *
{
...
auto QgsGeometryCheckDuplicateNodesAlgorithm::processAlgorithm( const QVariantMap &parameters, QgsProcessingContext &context, QgsProcessingFeedback *feedback ) -> QVariantMap
{
  QString dest_output;
  QString dest_errors;
