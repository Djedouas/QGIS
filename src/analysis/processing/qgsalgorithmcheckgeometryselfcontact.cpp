...
auto QgsGeometryCheckSelfContactAlgorithm::name() const -> QString
{
  return QStringLiteral( "checkgeometryselfcontact" );
}

auto QgsGeometryCheckSelfContactAlgorithm::displayName() const -> QString
{
  return QObject::tr( "Check Geometry (self contact)" );
}

auto QgsGeometryCheckSelfContactAlgorithm::tags() const -> QStringList
{
  return QObject::tr( "check,geometry,contact" ).split( ',' );
}

auto QgsGeometryCheckSelfContactAlgorithm::group() const -> QString
{
  return QObject::tr( "Check geometry" );
}

auto QgsGeometryCheckSelfContactAlgorithm::groupId() const -> QString
{
  return QStringLiteral( "checkgeometry" );
}

auto QgsGeometryCheckSelfContactAlgorithm::shortHelpString() const -> QString
{
  return QObject::tr( "This algorithm check if the geometry has self contact points (in line or polygon)." );
}

auto QgsGeometryCheckSelfContactAlgorithm::flags() const -> Qgis::ProcessingAlgorithmFlags
{
  return QgsProcessingAlgorithm::flags() | Qgis::ProcessingAlgorithmFlag::NoThreading;
}

auto QgsGeometryCheckSelfContactAlgorithm::createInstance() const -> QgsGeometryCheckSelfContactAlgorithm *
{
...
auto QgsGeometryCheckSelfContactAlgorithm::prepareAlgorithm( const QVariantMap &parameters, QgsProcessingContext &context, QgsProcessingFeedback * ) -> bool
{
...
auto QgsGeometryCheckSelfContactAlgorithm::createFeaturePool( QgsVectorLayer *layer, bool selectedOnly ) const -> QgsFeaturePool *
{
...
auto QgsGeometryCheckSelfContactAlgorithm::processAlgorithm( const QVariantMap &parameters, QgsProcessingContext &context, QgsProcessingFeedback *feedback ) -> QVariantMap
{
  QString dest_output;
  QString dest_errors;
