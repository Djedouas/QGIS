...
auto QgsGeometryCheckSegmentLengthAlgorithm::flags() const ->  Qgis::ProcessingAlgorithmFlags
{
...
void QgsGeometryCheckSegmentLengthAlgorithm::initAlgorithm( const QVariantMap &configuration )
{
  ...
  addParameter( new QgsProcessingParameterNumber( QStringLiteral( "MIN_SEGMENT_LENGTH" ), QObject::tr( "min segment length" ), Qgis::ProcessingNumberParameterType::Double, 0, false, 0.0 ) );
