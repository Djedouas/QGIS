...
auto QgsGeometryCheckLineLayerIntersectionAlgorithm::flags() const ->  Qgis::ProcessingAlgorithmFlags
{
...
void QgsGeometryCheckLineLayerIntersectionAlgorithm::initAlgorithm( const QVariantMap &configuration )
{
  ...
  addParameter( new QgsProcessingParameterFeatureSource( QStringLiteral( "INTERSECTION_LAYER" ), QObject::tr( "Intersection layer" ), QList< int >() << static_cast<int>( Qgis::ProcessingSourceType::VectorLine ) << static_cast<int>( Qgis::ProcessingSourceType::VectorPolygon ) ) );
