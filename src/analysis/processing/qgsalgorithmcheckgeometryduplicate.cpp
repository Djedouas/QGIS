...
auto QgsGeometryCheckDuplicateAlgorithm::name() const -> QString
{
  return QStringLiteral( "checkgeometryduplicate" );
}

auto QgsGeometryCheckDuplicateAlgorithm::displayName() const -> QString
{
  return QObject::tr( "Check Geometry (Duplicate)" );
}

auto QgsGeometryCheckDuplicateAlgorithm::tags() const -> QStringList
{
  return QObject::tr( "check,geometry,duplicate" ).split( ',' );
}

auto QgsGeometryCheckDuplicateAlgorithm::group() const -> QString
{
  return QObject::tr( "Check geometry" );
}

auto QgsGeometryCheckDuplicateAlgorithm::groupId() const -> QString
{
  return QStringLiteral( "checkgeometry" );
}

auto QgsGeometryCheckDuplicateAlgorithm::shortHelpString() const -> QString
{
  return QObject::tr( "This algorithm check the duplicate geometry." );
}

auto QgsGeometryCheckDuplicateAlgorithm::flags() const -> Qgis::ProcessingAlgorithmFlags
{
  return QgsProcessingAlgorithm::flags() | Qgis::ProcessingAlgorithmFlag::NoThreading;
}

auto QgsGeometryCheckDuplicateAlgorithm::createInstance() const -> QgsGeometryCheckDuplicateAlgorithm *
{
...
auto QgsGeometryCheckDuplicateAlgorithm::prepareAlgorithm( const QVariantMap &parameters, QgsProcessingContext &context, QgsProcessingFeedback * ) -> bool
{
...
auto QgsGeometryCheckDuplicateAlgorithm::createFeaturePool( QgsVectorLayer *layer, bool selectedOnly ) const -> QgsFeaturePool *
{
...
auto QgsGeometryCheckDuplicateAlgorithm::processAlgorithm( const QVariantMap &parameters, QgsProcessingContext &context, QgsProcessingFeedback *feedback ) -> QVariantMap
{
  QString dest_output;
  QString dest_errors;
